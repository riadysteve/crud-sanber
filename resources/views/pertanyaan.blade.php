                ...
                @foreach ($pertanyaan as $item)
                  <div class="card mb-3">
                    <div class="card-body">
                      ...
                      <p class="card-text"><small class="text-muted">{{ $item->tanggal_dibuat }}</small></p>
                      <div class="d-flex align-items-center">
                          <a href="/pertanyaan/{{ $item->id }}/edit" class="btn btn-warning btn-sm text-white mr-2">Edit Pertanyaan</a>
                      ...
                      <form action="/jawaban/{{ $item->id }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="isi" placeholder="Posting Jawaban Anda" class="form-control" id="exampleInputEmail1" rows="2" required></textarea>
                        </div>
                        <div class="form-group">
